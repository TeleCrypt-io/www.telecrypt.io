...
`export.txt` is served verbatim, and `privacy.txt` is generated from the same source as the privacy
page.
...
This public workflow verifies and publishes the static artifact; acceptance of the deployed site
is operator-managed outside this repository.
